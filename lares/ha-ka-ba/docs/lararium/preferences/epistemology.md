...
```toml
uri-path = "ha.ka.ba/docs/lararium/preferences/epistemology"
file-path = "lares/ha-ka-ba/docs/lararium/preferences/epistemology.md"
...
- **Stance-conditioned register reading**  
  `lar:///ha.ka.ba/api/v0.1/mu/the-syad-perspectives` feels mostly done as the tight invariant for:
...
- **Maybe logic / reality tunnel / catma braid**  
  `lar:///ha.ka.ba/api/v0.1/mu/the-law-of-5s` feels mostly done as the current compact live room for:
