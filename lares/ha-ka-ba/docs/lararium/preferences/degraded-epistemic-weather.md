...
```toml
uri-path = "ha.ka.ba/docs/lararium/preferences/degraded-epistemic-weather"
file-path = "lares/ha-ka-ba/docs/lararium/preferences/degraded-epistemic-weather.md"
