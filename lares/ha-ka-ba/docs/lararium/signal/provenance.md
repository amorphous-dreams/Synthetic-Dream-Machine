...
<<~&#x0001; ? -> lar:///ha.ka.ba/docs/lararium/signal/provenance >>

<<~ ahu #iam >>

```toml
uri-path = "ha.ka.ba/docs/lararium/signal/provenance"
file-path = "lares/ha-ka-ba/docs/lararium/signal/provenance.md"
...
Live HUD contract text stays in `lar:///ha.ka.ba/docs/lararium/signal/hud`.
Theory-facing framing stays in `lar:///ha.ka.ba/docs/lararium/signal/sa-display`.
