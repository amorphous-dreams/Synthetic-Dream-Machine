...
<<~&#x0001; ? -> lar:///ha.ka.ba/docs/lararium_mcp/spine >>

<<~ ahu #iam >>
```toml
uri-path     = "ha.ka.ba/docs/lararium_mcp/spine"
file-path    = "lares/ha-ka-ba/docs/lararium_mcp/spine.md"
...
- `lar:///ha.ka.ba/**` file-backed resources under the stable tuple root
...
| `lar:///ha.ka.ba/**` | stable tuple root mapped into `lares/ha-ka-ba/**` |
