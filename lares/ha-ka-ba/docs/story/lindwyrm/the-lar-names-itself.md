...
```toml
uri-path = "ha.ka.ba/docs/story/lindwyrm/the-lar-names-itself"
file-path = "lares/ha-ka-ba/docs/story/lindwyrm/the-lar-names-itself.md"
...
<<~ pranala #consumed-from-act-vi ? -> lar:///ha.ka.ba/docs/infrastructure-as-mythology/LINDWYRM_ACT_VI_DRAFT family:reference role:source >>
