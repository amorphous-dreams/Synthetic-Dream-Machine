...
```toml
uri-path = "ha.ka.ba/docs/story/lindwyrm/vault-and-repo"
file-path = "lares/ha-ka-ba/docs/story/lindwyrm/vault-and-repo.md"
...
source = "lar:///ha.ka.ba/docs/story/lindwyrm/hoard-origin-architecture#act-i-vault-repo"
...
- `lar:///ha.ka.ba/docs/story/lindwyrm/hoard-origin-architecture#act-i-vault-repo`
...
```text
@lindwyrm@new-delos — YOLD 4995, 14 Bureaucracy, origin thread — //memory.vault.opens [S:0.66] 🏛️+🌊++🗡️-🎭-🔮-
```
...
<<~ pranala #feeds-next-act ? -> lar:///ha.ka.ba/docs/story/lindwyrm/daemon-in-the-walls family:relation role:precedes >>
