...
<<~&#x0001; ? -> lar:///ha.ka.ba/docs/pono/tagspace-trust >>

<<~ ahu #iam >>
```toml
uri-path = "ha.ka.ba/docs/pono/tagspace-trust"
file-path = "lares/ha-ka-ba/docs/pono/tagspace-trust.md"
...
This docs meme explains `lar:///ha.ka.ba/api/v0.1/lararium/tagspace-trust`.
...
```text
lar:///ha.ka.ba/api/v0.1/lararium/tagspace-trust
```
...
```text
lar:///ha.ka.ba/library/discordia/the-count-of-5s/common-sense-tarot
```
