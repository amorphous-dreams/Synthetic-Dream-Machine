...
Law lives in `lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext`.
...
- parent invariant at `lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext`
- operational procedure at `lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext/SKILL`
