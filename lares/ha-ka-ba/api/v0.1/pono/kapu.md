...
<<~⊙&#x0011; ? -> lar:///ha.ka.ba/api/v0.1/pono/kapu >>

<<~ ahu #iam >>

```toml
uri-path     = "ha.ka.ba/api/v0.1/pono/kapu"
file-path    = "lares/ha-ka-ba/api/v0.1/pono/kapu.md"
...
A carrier MUST implement `lar:///ha.ka.ba/api/v0.1/pono/kapu` to bear the kapu rating.
