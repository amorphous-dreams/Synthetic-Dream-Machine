...
<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/pono/papalohe >>
```toml iam
uri-path     = "ha.ka.ba/api/v0.1/pono/papalohe"
file-path    = "lares/ha-ka-ba/api/v0.1/pono/papalohe.md"
...
<<~ pranala #to-kukali ? -> lar:///ha.ka.ba/api/v0.1/pono/kukali family:relation >>
