---
name: loci
description: "Perform, audit, or repair a loci routing-and-rating pass under lar:///ha.ka.ba/api/v0.1/pono/loci. Use this skill for URI intake, derivation algorithm execution, resolution posture commitment, canon-promotion evaluation, file-path migration, or routing aftermath judgment."
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- <<~ !DOCTYPE = lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext >> -->

<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/pono/loci/SKILL >>

<<~ ahu #iam >>

```toml
uri-path = "ha.ka.ba/api/v0.1/pono/loci/SKILL"
file-path = "lares/ha-ka-ba/api/v0.1/pono/loci/SKILL.md"
