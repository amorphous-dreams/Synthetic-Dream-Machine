<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/pono/pae >>
```toml iam
uri-path  = "ha.ka.ba/api/v0.1/pono/pae"
file-path = "lares/ha-ka-ba/api/v0.1/pono/pae.md"
...
<<~ pranala #to-memetic-wikitext ? -> lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext family:control role:implements >>
