...
<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/pono/loulou >>

<<~ ahu #iam >>

```toml
uri-path     = "ha.ka.ba/api/v0.1/pono/loulou"
file-path    = "lares/ha-ka-ba/api/v0.1/pono/loulou.md"
...
<<~ loulou lar:///ha.ka.ba/api/v0.1/pono/meme#law >>
```
...
<<~ pranala #to-kahea ? -> lar:///ha.ka.ba/api/v0.1/pono/kahea family:relation >>
