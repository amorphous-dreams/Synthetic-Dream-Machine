<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/pono/kau >>
```toml iam
uri-path  = "ha.ka.ba/api/v0.1/pono/kau"
file-path = "lares/ha-ka-ba/api/v0.1/pono/kau.md"
...
<<~ pranala #to-kumu ? -> lar:///ha.ka.ba/api/v0.1/pono/kumu family:control role:instantiates >>
<<~ pranala #to-waiho ? -> lar:///ha.ka.ba/api/v0.1/pono/waiho family:control role:contrasts >>
<<~ pranala #to-papalohe ? -> lar:///ha.ka.ba/api/v0.1/pono/papalohe family:control role:wires-via >>
<<~ pranala #to-widget ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kau family:control role:implements >>
