...
<<~ pranala #to-memetic-wikitext ? -> lar:///ha.ka.ba/api/v0.1/pono/memetic-wikitext family:control role:extends >>
<<~ pranala #to-kapu ? -> lar:///ha.ka.ba/api/v0.1/pono/kapu family:control role:depends >>
<<~ pranala #to-mu ? -> lar:///ha.ka.ba/api/v0.1/mu family:observe role:observes >>
