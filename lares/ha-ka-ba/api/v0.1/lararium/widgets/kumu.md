<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kumu >>
```toml iam
uri-path      = "ha.ka.ba/api/v0.1/lararium/widgets/kumu"
file-path     = "lares/ha-ka-ba/api/v0.1/lararium/widgets/kumu.md"
...
module-ref    = "lar:///ha.ka.ba/api/v0.1/lararium/widgets/kumu-tw5"
body-sha256   = "b50e6feb9da619910ae1940d8e22fa53c4fe4349060e5545f1c95281453f3fa6"
cacheable     = true
retain        = true
```
...
<<~ pranala #to-pono ? -> lar:///ha.ka.ba/api/v0.1/pono/kumu family:control role:implements >>
<<~ pranala #to-tw5-widgets ? -> lar:///ha.ka.ba/api/v0.1/lararium/modules/tw5-widgets family:control role:implements >>
<<~ pranala #to-module ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kumu-tw5 family:control role:module >>
