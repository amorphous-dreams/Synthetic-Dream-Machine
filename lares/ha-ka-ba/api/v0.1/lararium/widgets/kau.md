<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kau >>
```toml iam
uri-path      = "ha.ka.ba/api/v0.1/lararium/widgets/kau"
file-path     = "lares/ha-ka-ba/api/v0.1/lararium/widgets/kau.md"
...
module-ref    = "lar:///ha.ka.ba/api/v0.1/lararium/widgets/kau-tw5"
body-sha256   = ""
cacheable     = true
retain        = true
```
...
<<~ pranala #to-pono ? -> lar:///ha.ka.ba/api/v0.1/pono/kau family:control role:implements >>
<<~ pranala #to-tw5-widgets ? -> lar:///ha.ka.ba/api/v0.1/lararium/modules/tw5-widgets family:control role:implements >>
<<~ pranala #to-module ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kau-tw5 family:control role:module >>
<<~ pranala #to-kumu ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/kumu family:control role:depends >>
