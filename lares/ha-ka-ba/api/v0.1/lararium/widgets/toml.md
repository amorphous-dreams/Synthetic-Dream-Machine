<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/toml >>
```toml iam
uri-path      = "ha.ka.ba/api/v0.1/lararium/widgets/toml"
file-path     = "lares/ha-ka-ba/api/v0.1/lararium/widgets/toml.md"
...
<<~ pranala #to-pono ? -> lar:///ha.ka.ba/api/v0.1/pono/toml family:control role:implements >>
<<~ pranala #to-tw5-widgets ? -> lar:///ha.ka.ba/api/v0.1/lararium/modules/tw5-widgets family:control role:implements >>
<<~ pranala #to-module ? -> lar:///ha.ka.ba/api/v0.1/lararium/widgets/toml-tw5 family:control role:module >>
