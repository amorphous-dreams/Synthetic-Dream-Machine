...
<<~&#x0001; ? -> lar:///ha.ka.ba/api/v0.1/lararium/modules/tw5-widgets >>

<<~ ahu #iam >>
```toml
uri-path      = "ha.ka.ba/api/v0.1/lararium/modules/tw5-widgets"
file-path     = "lares/ha-ka-ba/api/v0.1/lararium/modules/tw5-widgets.md"
...
<<~ pranala #to-carrier-sigils ? -> lar:///ha.ka.ba/api/v0.1/pono/carrier-sigils family:control role:depends >>
<<~ pranala #to-papalohe ? -> lar:///ha.ka.ba/api/v0.1/pono/papalohe family:control role:implements >>
<<~ pranala #to-kukali ? -> lar:///ha.ka.ba/api/v0.1/pono/kukali family:control role:implements >>
