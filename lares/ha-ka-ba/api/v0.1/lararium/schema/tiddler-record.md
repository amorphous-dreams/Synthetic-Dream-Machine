...
<<~ ahu #iam >>
```toml
uri-path     = "ha.ka.ba/api/v0.1/lararium/schema/tiddler-record"
file-path    = "lares/ha-ka-ba/api/v0.1/lararium/schema/tiddler-record.md"
...
<<~ pranala #projection-codec ? -> lar:///ha.ka.ba/api/v0.1/lararium/schema/projection-codec family:data role:companion >>
<<~ pranala #used-by-adaptor ? -> lar:///ha.ka.ba/api/v0.1/lararium/modules/sync-adaptor family:control role:governs >>
