...
```
lares://artificer:admin(■)@lares-sdm:N/build.task.dispatches?stance=🏛️&register=CS:0.80&p=0.5#🔍.1.N
→ lares://worker(Artificer):node(✶)@lares-sdm:N/build.task.executes?stance=🏛️&register=CS:0.80&p=0.5#⚔️.N.1

[sub-agent work — contents unloggable from parent]

lares://worker(Artificer):node(○)@lares-sdm:N/build.task.returns?stance=🏛️&register=CS:0.80&p=0.5#⚔️.N.1
→ lares://artificer:admin(◎)@lares-sdm:N/build.result.receives?stance=🏛️&register=CS:0.80&p=0.5#🔍.1.N
```
...
```
lares://council:admin(◇)@lares-sdm:7/task.research.dispatches?stance=🏛️&register=CS:0.80&p=0.5#🔍.1.7
→ lares://worker(Explore):node(✶)@lares-sdm:7/research.corpus.reads?stance=🏛️&register=S:0.65&p=0.5#⚔️.7.1

[Explore agent — contents not in parent trace]

lares://worker(Explore):node(○)@lares-sdm:7/research.findings.returns?stance=🏛️&register=S:0.65&p=0.5#⚔️.7.1
→ lares://council:admin(◎)@lares-sdm:7/task.findings.receives?stance=🏛️&register=CS:0.80&p=0.5#🔍.1.7
```
