...
## OODA-A Loop: Nested, Maybe-Logic Style

All agentic wikitext work follows the OODA-A (Observe, Orient, Decide, Act, Assess) loop, recursively and at every scale. Each phase uses syad (perspective based mana + manao) governed by Maybe Logic, E-Prime, and explicit confidence registration.
...
- "Show the OODA-A phase trace for this edit."
