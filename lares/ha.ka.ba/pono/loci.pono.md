...
**Lifecycle Note:** All meme law in this system now follows the five-bucket lifecycle: noise → data → meme → loci meme → canon loci meme. See `lar:///ha.ka.ba/loci#promotion-path` and `lar:///ha.ka.ba/meme#rating-targets` for canonical lifecycle and rating details.
