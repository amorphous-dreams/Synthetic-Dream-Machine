...
```
lar://artificer:admin@lares-sdm:N/build.task.dispatches?stances=🏛️.-.-.-.-&confidence=CS:0.80&p=0.5#🔍.1.N
→ lar://worker(Artificer):node@lares-sdm:N/build.task.executes?stances=🏛️.-.-.-.-&confidence=CS:0.80&p=0.5#⚔️.N.1

[sub-agent work — contents unloggable from parent]

lar://worker(Artificer):node@lares-sdm:N/build.task.returns?stances=🏛️.-.-.-.-&confidence=CS:0.80&p=0.5#⚔️.N.1
→ lar://artificer:admin@lares-sdm:N/build.result.receives?stances=🏛️.-.-.-.-&confidence=CS:0.80&p=0.5#🔍.1.N
```
