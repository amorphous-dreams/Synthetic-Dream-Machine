...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets#migrated-sigilization-design-intent`
...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets#migrated-sigilization-mapping-tables`
...
**Consumed into**
- `packages/lares-core/memes/api/v0.1/mu/the-syad-perspectives.md#stance-flags`
