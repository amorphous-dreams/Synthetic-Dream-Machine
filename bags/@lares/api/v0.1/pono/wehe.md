...
*wehe* — Hawaiian: to open, to separate, to move aside; outside, exterior; exit boundary.
...
English alias: `\procedure` (TW5 pragma form). Both forms produce the same parse result.
