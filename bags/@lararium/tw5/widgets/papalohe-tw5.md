...
file-path = "bags/@lararium/tw5/widgets/papalohe-tw5.md"
...
Compiled CJS artifact. Canonical TS source: `packages/lararium-tw5/src/tw5-widgets.ts` (`source-symbol = "PapaloheWidget"`).
