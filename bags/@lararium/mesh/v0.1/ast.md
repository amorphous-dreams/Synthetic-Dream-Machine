...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/mesh/v0.1/ast >>
```toml iam
uri-path     = "ha.ka.ba/@lararium/mesh/v0.1/ast"
file-path    = "bags/@lararium/mesh/v0.1/ast.md"
...
Shared by `meme-graph.ts`, `compiler.ts`, `pranala-parser.ts` in `@lararium/mesh` — available to any package without pulling in the parser.
