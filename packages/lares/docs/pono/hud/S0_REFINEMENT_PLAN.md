...
| 3 | 2026-04-08 | **Partially legacy.** Syadasti reading rule and stance semantics survived; stance-count-as-fuzz did not. | F-report + G-report lineage; live fold now in `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md` |
...
- `[DECISION]` centroid~δ notation REVERTED — ⚠️ legacy bridge. The live fold keeps register as a point and marks stance-count-as-fuzz as superseded in `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#legacy-notes`.
- `[DECISION]` Register is stance-dependent (Syadasti/Saptabhangi ground). ♻️ Consumed into `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#reading-question`.
...
**The Triangle:** syad-specific multi-stance spread material consumed into `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#multi-stance-boundary`.
...
**Consumed into**
- `lares/ha-ka-ba/api/v0.1/mu/the-syad-perspectives.md#syad-law`
- `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#reading-question`
- `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#saptabhangi`
- `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#stance-endpoints`
...
**Multi-stance reading:** consumed into `lares/ha-ka-ba/docs/mu/the-syad-perspectives/README.md#multi-stance-boundary`.
