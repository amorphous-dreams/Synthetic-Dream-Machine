...
file-path = "packages/lares/api/v0.1/pono/orichalcum-capabilities.md"
...
<<~ pranala #required-by-federation ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/federated-causal-islands family:control role:required-by >>
