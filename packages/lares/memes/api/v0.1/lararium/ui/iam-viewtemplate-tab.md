...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/ui/iam-viewtemplate-tab"
file-path = "packages/lares/memes/api/v0.1/lararium/ui/iam-viewtemplate-tab.md"
...
<$transclude tiddler="lar:///ha.ka.ba/@lares/api/v0.1/lararium/ui/iam-panel" mode="block" />
</$list>
</$reveal>
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/ui/iam-panel >>
