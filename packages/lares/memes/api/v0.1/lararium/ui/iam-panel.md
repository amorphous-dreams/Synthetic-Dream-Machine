...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/ui/iam-panel"
file-path = "packages/lares/memes/api/v0.1/lararium/ui/iam-panel.md"
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/ui/iam-viewtemplate-tab >>
