---
name: lar-uri
description: "Parse, construct, validate, or audit lar: URIs under lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri. Use this skill when working with URI well-formedness, canonical form conversion, stable address derivation, authority slot assembly, or FFZ chronometer encoding."
...
covers = ["lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri"]
constraints = [
