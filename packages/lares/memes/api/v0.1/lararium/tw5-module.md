...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/tw5-module"
file-path = "packages/lares/memes/api/v0.1/lararium/tw5-module.md"
...
A carrier that implements `lar:///ha.ka.ba/@lares/api/v0.1/lararium/tw5-module` declares itself as a
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/tw5-modules >>
