...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/schema/tiddler-record"
file-path = "packages/lares/memes/api/v0.1/lararium/schema/tiddler-record.md"
...
<<~ pranala #projection-codec ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/schema/projection-codec family:data role:companion >>
<<~ pranala #used-by-adaptor ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/sync-adaptor family:control role:governs >>
