...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/schema/catalog-doc >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/schema/catalog-doc"
file-path = "packages/lares/memes/api/v0.1/lararium/schema/catalog-doc.md"
...
<<~ pranala #to-auth-providers ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/schema/auth-providers family:control role:depends >>
