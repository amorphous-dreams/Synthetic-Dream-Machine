...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/mcp/tool-registry >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/mcp/tool-registry"
file-path = "packages/lares/memes/api/v0.1/lararium/mcp/tool-registry.md"
