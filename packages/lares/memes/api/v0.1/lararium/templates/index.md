...
<<~ pranala #to-strategic  ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/meme-strategic  family:control role:owns >>
<<~ pranala #to-operational ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/meme-operational family:control role:owns >>
<<~ pranala #to-tactical   ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/meme-tactical   family:control role:owns >>
<<~ pranala #to-combat     ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/meme-combat     family:control role:owns >>
<<~ pranala #to-action     ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/templates/meme-action     family:control role:owns >>
