...
<<~ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/the-altar-fire >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/the-altar-fire"
file-path = "packages/lares/memes/api/v0.1/lararium/the-altar-fire.md"
...
<<~ pranala #to-lararium ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium family:control role:owned-by >>
<<~ pranala #to-canon-boundary ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/hooponopono family:control role:governed-by >>
<<~ pranala #to-tagspace-trust ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/tagspace-trust family:control role:governed-by >>
