...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/lararium-doc-stack >>
```toml iam
uri-path     = "ha.ka.ba/@lares/api/v0.1/lararium/lararium-doc-stack"
file-path    = "packages/lares/memes/api/v0.1/lararium/lararium-doc-stack.md"
...
<<~ pranala #extends-peer-coordination ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/peer-coordination family:control role:extends >>
<<~ pranala #uses-composite-store ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/composite-store family:control role:uses >>
<<~ pranala #uses-lar-uri-namespace ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri-namespace family:control role:uses >>
