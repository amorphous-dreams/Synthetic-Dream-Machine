...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri-namespace >>
```toml iam
uri-path     = "ha.ka.ba/@lares/api/v0.1/lararium/lar-uri-namespace"
file-path    = "packages/lares/memes/api/v0.1/lararium/lar-uri-namespace.md"
...
<<~ pranala #constrains-peer-coordination ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/peer-coordination family:control role:constrains >>
<<~ pranala #constrains-identity-slot ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/identity-slot family:control role:constrains >>
<<~ pranala #constrains-composite-store ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/composite-store family:control role:constrains >>
