...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/modules/tw5-modules"
file-path = "packages/lares/api/v0.1/lararium/modules/tw5-modules.md"
...
cacheable       = true
retain          = true
implements      = ["lar:///ha.ka.ba/@lares/api/v0.1/lararium/tw5-module"]
...
<<~ pranala #implements-tw5-module ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/tw5-module family:control role:implements >>
