...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/implementors >>
```toml iam
uri-path    = "ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/implementors"
file-path   = "packages/lares/memes/api/v0.1/lararium/modules/filter-operators/implementors.md"
