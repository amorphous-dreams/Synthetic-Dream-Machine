...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/memes >>
```toml iam
uri-path    = "ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/memes"
file-path   = "packages/lares/memes/api/v0.1/lararium/modules/filter-operators/memes.md"
