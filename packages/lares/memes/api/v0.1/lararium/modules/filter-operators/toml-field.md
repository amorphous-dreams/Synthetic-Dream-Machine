...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/toml-field >>
```toml iam
uri-path    = "ha.ka.ba/@lares/api/v0.1/lararium/modules/filter-operators/toml-field"
file-path   = "packages/lares/memes/api/v0.1/lararium/modules/filter-operators/toml-field.md"
