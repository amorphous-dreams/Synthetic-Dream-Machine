...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/canvas/projection-records >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/canvas/projection-records"
file-path = "packages/lares/memes/api/v0.1/lararium/canvas/projection-records.md"
...
<<~ pranala #to-layout-geometry ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/canvas/layout-geometry family:control role:depends >>
<<~ pranala #to-pranala-families ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/pranala-families family:control role:depends >>
