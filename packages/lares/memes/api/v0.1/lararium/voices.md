...
<<~ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/lararium/voices"
file-path = "packages/lares/memes/api/v0.1/lararium/voices.md"
...
Tool-carry pairs apply per the stance law (`lar:///ha.ka.ba/@lares/api/v0.1/mu/the-four-tools`). Stance law MAY be revised; this rule follows it.
