...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets#migrated-sigilization-mandatory-rules`
...
**Rules 3–5 consumed** → `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#stance-array`
...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets#migrated-sigilization-per-surface-rules`
...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets#migrated-sigilization-amplitude-quick-reference`
