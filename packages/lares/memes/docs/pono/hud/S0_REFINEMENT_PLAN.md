...
| 3 | 2026-04-08 | **Partially legacy.** Syadasti reading rule and stance semantics survived; stance-count-as-fuzz did not. | F-report + G-report lineage; live fold now in `packages/lares/memes/docs/mu/the-syad-perspectives/README.md` |
...
- `[DECISION]` centroid~δ notation REVERTED — ⚠️ legacy bridge. The live fold keeps register as a point and marks stance-count-as-fuzz as superseded in `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#legacy-notes`.
- `[DECISION]` Register is stance-dependent (Syadasti/Saptabhangi ground). ♻️ Consumed into `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#reading-question`.
...
Consumed into:
- `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud#migrated-hud-anatomy-symbol-table`
...
**The Triangle:** syad-specific multi-stance spread material consumed into `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#multi-stance-boundary`.
...
**Consumed into**
- `packages/lares/memes/api/v0.1/mu/the-syad-perspectives.md#syad-law`
- `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#reading-question`
- `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#saptabhangi`
- `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#stance-endpoints`
...
**Multi-stance reading:** consumed into `packages/lares/memes/docs/mu/the-syad-perspectives/README.md#multi-stance-boundary`.
...
| 8 | Kowloon/AP handle form + render target taxonomy (§3.3.1) | Social-layer identity canonized; three render surfaces named | URI_SCHEMA.md, `lar:///ha.ka.ba/@lares/docs/story/lindwyrm/dreamdeck-feed-architecture` |
| 9 | Stance amplitude modifiers `++`/`+`/(none)/`-`/`--` (§3.3.1) | Amplitude disambiguation independent of stance-count fuzz | URI_SCHEMA.md, `lar:///ha.ka.ba/@lares/docs/story/lindwyrm/dreamdeck-feed-architecture` |
