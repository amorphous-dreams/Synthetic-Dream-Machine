/**
 * meme-ast/index.ts — barrel for @lararium/core meme-ast sub-module.
 *
 * Public API for isomorphic memetic-wikitext parsing.
 * Import via: import { parseMemeText } from "@lararium/core/meme-ast"
 * Or from core barrel: import { parseMemeText } from "@lararium/core"
 *
