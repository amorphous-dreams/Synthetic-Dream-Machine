...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/schema/template-cascade >>
```toml iam
uri-path = "ha.ka.ba/@lararium/tw5/schema/template-cascade"
file-path = "packages/lararium-tw5/memes/schema/template-cascade.md"
...
<<~ pranala #to-corpus-sources ? -> lar:///ha.ka.ba/@lararium/tw5/schema/corpus-sources family:control role:depends >>
