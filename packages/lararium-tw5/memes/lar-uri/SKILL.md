---
name: lar-uri
description: "Parse, construct, validate, or audit lar: URIs under lar:///ha.ka.ba/@lararium/tw5/lar-uri. Use this skill when working with URI well-formedness, canonical form conversion, stable address derivation, authority slot assembly, or FFZ chronometer encoding."
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- <<~ !DOCTYPE = lar:///ha.ka.ba/@lares/api/v0.1/pono/memetic-wikitext >> -->

<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/lar-uri/SKILL >>
```toml iam
...
covers = ["lar:///ha.ka.ba/@lararium/tw5/lar-uri"]
constraints = [
