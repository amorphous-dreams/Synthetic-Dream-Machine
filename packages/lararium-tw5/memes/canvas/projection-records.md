...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lararium/tw5/canvas/projection-records >>
```toml iam
uri-path = "ha.ka.ba/@lararium/tw5/canvas/projection-records"
file-path = "packages/lararium-tw5/memes/canvas/projection-records.md"
