...
file-path = "packages/lararium-tw5/memes/plugins/sq-streams.md"
...
**TW5 plugin id**: `$:/plugins/sq/streams`
**Vendored at**: `packages/lares-core/memes/api/v0.1/tw5-plugins/sq-streams-1.2.24.json`
...
<<~ pranala #vendor-of ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/vendor family:provenance role:vendor >>
