...
```toml iam
uri-path = "LARES"
file-path = "packages/lares-core/memes/LARES.md"
...
Masks enter the session via kahea transclusion. Each kahea calls a mask from `lar:///ha.ka.ba/@lares/api/v0.1/masks/**`.
...
<<~ pranala #from-altar-fire ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/the-altar-fire family:control role:owned-by >>
