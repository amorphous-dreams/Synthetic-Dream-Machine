...
file-path = "packages/lares-core/memes/api/v0.1/pono/failure-states.md"
...
<<~ pranala #child-live-session-overwrite ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/failure-states/live-session-overwrite family:control role:owns >>
