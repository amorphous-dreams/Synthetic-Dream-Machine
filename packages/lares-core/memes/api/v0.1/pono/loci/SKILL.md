---
name: loci
description: "Perform, audit, or repair a loci routing-and-rating pass under lar:///ha.ka.ba/@lares/api/v0.1/pono/loci. Use this skill for URI intake, derivation algorithm execution, resolution posture commitment, canon-promotion evaluation, file-path migration, or routing aftermath judgment."
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- <<~ !DOCTYPE = lar:///ha.ka.ba/@lares/api/v0.1/pono/memetic-wikitext >> -->

<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/SKILL >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/loci/SKILL"
file-path = "packages/lares-core/memes/api/v0.1/pono/loci/SKILL.md"
...
covers = ["lar:///ha.ka.ba/@lares/api/v0.1/pono/loci"]
constraints = [
...
skill-package-root = "packages/lares-core/memes/api/v0.1/pono/loci"
```
...
- MCP server design or live-resolver research → `lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/iam`
- generic meme law → `lar:///ha.ka.ba/@lares/api/v0.1/pono/meme`
- invariant compression or sidecar splitting → `lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant/SKILL`
...
- canon-lifecycle: a carrier may not self-promote; all conditions in `lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/iam` MUST hold
