...
<<~⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/failure-states/live-session-overwrite >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/failure-states/live-session-overwrite"
file-path = "packages/lares-core/memes/api/v0.1/pono/failure-states/live-session-overwrite.md"
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/pono/canon-promotion-boundary >>
