...
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/loci"
file-path = "packages/lares-core/memes/api/v0.1/pono/loci.md"
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/SKILL >>
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/iam >>
...
2. Derive candidate filepath:
     ...
     If root == "ha.ka.ba":
       ...
       e.g. "packages/lares-core/memes/api/v0.1/pono/loci.md"
     Else:
...
`lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant/SKILL` → `packages/lares-core/memes/api/v0.1/pono/invariant/SKILL.md`
...
|---|---|---|
| primary meme | derivation algorithm (step 2) | `packages/lares-core/memes/api/v0.1/pono/loci.md` |
| child item | sibling directory named for parent's terminal path segment | `packages/lares-core/memes/api/v0.1/pono/loci/iam.md` |

Any carrier outside this rule reads as repair pressure, not a second lawful siting convention.
This file at `packages/lares-core/memes/api/v0.1/pono/loci.md` with children under `packages/lares-core/memes/api/v0.1/pono/loci/` serves as live specimen.

### Live Examples

| lar: URI | derived candidate | outcome |
|---|---|---|
| `lar:///ha.ka.ba/@lares/api/v0.1/pono/loci` | `packages/lares-core/memes/api/v0.1/pono/loci.md` | resolved |
| `lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/iam` | `packages/lares-core/memes/api/v0.1/pono/loci/iam.md` | resolved |
| `lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant/SKILL` | `packages/lares-core/memes/api/v0.1/pono/invariant/SKILL.md` | resolved |
...
4. canon-promotion criteria (`lar:///ha.ka.ba/@lares/api/v0.1/pono/loci/iam`)
