---
name: invariant
description: Generate, compress, or audit invariant-compliant memes under lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant. Treat the canonical loci as self-describing law and self-executing template; keep invariant surfaces short, exact, stable, cacheable, and split heavy matter outward.
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- !DOCTYPE = lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant -->

<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant/SKILL >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/invariant/SKILL"
file-path = "packages/lares-core/memes/api/v0.1/pono/invariant/SKILL.md"
...
skill-package-root = "packages/lares-core/memes/api/v0.1/pono/invariant"
```
