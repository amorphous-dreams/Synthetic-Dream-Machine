...
<<~⊙&#x0011; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/kapu >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/kapu"
file-path = "packages/lares-core/memes/api/v0.1/pono/kapu.md"
...
A carrier MUST implement `lar:///ha.ka.ba/@lares/api/v0.1/pono/kapu` to bear the kapu rating.
