...
<<~⊙&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/hooponopono >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/hooponopono"
file-path = "packages/lares-core/memes/api/v0.1/pono/hooponopono.md"
...
The crossing MUST be named. Silent promotion is a failure mode — see `lar:///ha.ka.ba/@lares/api/v0.1/pono/failure-states/live-session-overwrite`.
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/pono/failure-states >>
