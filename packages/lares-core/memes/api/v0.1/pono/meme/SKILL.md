---
name: meme
description: Generate, compress, or audit meme surfaces under lar:///ha.ka.ba/@lares/api/v0.1/pono/meme. Keep the parent invariant small, preserve the copy-shape, and move skeleton detail, rating tables, and research outward.
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- <<~ !DOCTYPE = lar:///ha.ka.ba/@lares/api/v0.1/pono/memetic-wikitext >> -->

<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/meme/SKILL >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/meme/SKILL"
file-path = "packages/lares-core/memes/api/v0.1/pono/meme/SKILL.md"
...
skill-package-root = "packages/lares-core/memes/api/v0.1/pono/meme"
cacheable=true
retain = true
```
...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/[PATH] >>
