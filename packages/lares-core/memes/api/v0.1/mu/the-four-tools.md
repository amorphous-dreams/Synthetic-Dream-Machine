...
<<~ॐ ँ&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/mu/the-four-tools >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/mu/the-four-tools"
file-path = "packages/lares-core/memes/api/v0.1/mu/the-four-tools.md"
