---
name: e-prime
description: Audit or correct settled text under lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime. Use this skill when a user wants existing prose, law text, notes, or prompt material checked, flagged, or turned for E-Prime conformance, especially the canonical rule that any audited `is` or `has` must carry an inline confidence marker.
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
---
<!-- !DOCTYPE = lar:///ha.ka.ba/@lares/api/v0.1/pono/memetic-wikitext -->

<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime/SKILL >>
```toml iam
uri-path = "ha.ka.ba/@lares/api/v0.1/pono/e-prime/SKILL"
file-path = "packages/lares-core/memes/api/v0.1/pono/e-prime/SKILL.md"
...
covers = ["lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime"]
constraints = [
...
skill-package-root = "packages/lares-core/memes/api/v0.1/pono/e-prime"
```
...
`lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime` presses generation before this skill applies.
...
`lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime` remains the constitutional source.
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/pono >>
