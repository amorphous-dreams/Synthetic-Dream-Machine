...
file-path = "packages/lares-core/memes/docs/lararium_mcp/hydration.md"
...
| 2 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime` | `packages/lares-core/memes/api/v0.1/pono/e-prime.md` | `AGENTS#preload-e-prime` |
| 3 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/ooda-ha` | `packages/lares-core/memes/api/v0.1/pono/ooda-ha.md` | `AGENTS#preload-ooda-ha` |
| 4 | `lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri` | `packages/lares-core/memes/api/v0.1/pono/lar-uri.md` | `AGENTS#preload-lar-uri` |
| 5 | `lar:///ha.ka.ba/@lares/api/v0.1/mu` | `packages/lares-core/memes/api/v0.1/mu.md` | `AGENTS#threshold-to-mu` |
| 6 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/chao` | `packages/lares-core/memes/api/v0.1/mu/chao.md` | Mu internal hydration |
| 7 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-four-tools` | `packages/lares-core/memes/api/v0.1/mu/the-four-tools.md` | Mu internal hydration |
| 8 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-law-of-5s` | `packages/lares-core/memes/api/v0.1/mu/the-law-of-5s.md` | Mu internal hydration |
| 9 | `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-syad-perspectives` | `packages/lares-core/memes/api/v0.1/mu/the-syad-perspectives.md` | Mu internal hydration |
| 10 | `lar:///ha.ka.ba/@lares/api/v0.1/lararium` | `packages/lares-core/memes/api/v0.1/lararium.md` | `AGENTS#threshold-to-lararium` |
| 11 | `lar:///ha.ka.ba/@lares/api/v0.1/lararium/hud` | `packages/lares-core/memes/api/v0.1/lararium/hud.md` | Lararium internal hydration |
| 12 | `lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices` | `packages/lares-core/memes/api/v0.1/lararium/voices.md` | Lararium internal hydration |
| 13 | `lar:///ha.ka.ba/@lares/api/v0.1/lararium/continuity` | `packages/lares-core/memes/api/v0.1/lararium/continuity.md` | Lararium internal hydration |
