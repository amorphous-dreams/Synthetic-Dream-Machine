...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets >>
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal/render-targets"
file-path = "packages/lares-core/memes/docs/lararium/signal/render-targets.md"
...
Exchange contract stays at `lar:///ha.ka.ba/@lares/docs/lararium/signal`.
HUD instrument reading stays at `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/HUD-ANATOMY#kowloon-dreamdeck`.
