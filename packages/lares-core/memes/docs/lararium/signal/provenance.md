...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/lararium/signal/provenance >>
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal/provenance"
file-path = "packages/lares-core/memes/docs/lararium/signal/provenance.md"
...
Live HUD contract text stays in `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
Theory-facing framing stays in `lar:///ha.ka.ba/@lares/docs/lararium/signal/sa-display`.
