...
file-path = "packages/lares-core/memes/docs/lararium/signal/micro-trace.md"
...
The live HUD line and field-reading contract stay in `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
Drift recovery pressure now lives in `lar:///ha.ka.ba/@lares/docs/lararium/signal/drift`.
