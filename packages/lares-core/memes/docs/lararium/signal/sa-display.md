...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal/sa-display"
file-path = "packages/lares-core/memes/docs/lararium/signal/sa-display.md"
...
Branch contract stays at `lar:///ha.ka.ba/@lares/docs/lararium/signal`.
HUD witness and annotation behavior stay at `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
