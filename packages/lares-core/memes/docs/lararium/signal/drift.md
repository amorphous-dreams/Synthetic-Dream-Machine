...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/lararium/signal/drift >>
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal/drift"
file-path = "packages/lares-core/memes/docs/lararium/signal/drift.md"
...
The live HUD line stays in `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud`.
The in-span annotation contract stays in `lar:///ha.ka.ba/@lares/docs/lararium/signal/micro-trace`.
