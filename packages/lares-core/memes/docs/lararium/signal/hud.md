...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal/hud"
file-path = "packages/lares-core/memes/docs/lararium/signal/hud.md"
...
Micro-trace, provenance, and drift now live in sibling rooms under `lar:///ha.ka.ba/@lares/docs/lararium/signal`.
...
Parent-branch framing now lives up at `lar:///ha.ka.ba/@lares/docs/lararium/signal`.
Micro-trace now lives at `lar:///ha.ka.ba/@lares/docs/lararium/signal/micro-trace`.
Provenance now lives at `lar:///ha.ka.ba/@lares/docs/lararium/signal/provenance`.
Drift recovery now lives at `lar:///ha.ka.ba/@lares/docs/lararium/signal/drift`.
...
- full micro-trace syntax, density bands, handoff protocol, and examples → `lar:///ha.ka.ba/@lares/docs/lararium/signal/micro-trace`
- drift recovery protocol pressure → `lar:///ha.ka.ba/@lares/docs/lararium/signal/drift`
- provenance, archive witness, and snapshot residue → `lar:///ha.ka.ba/@lares/docs/lararium/signal/provenance`
- shared-SA research framing and SA-vs-XAI theory → `lar:///ha.ka.ba/@lares/docs/lararium/signal/sa-display`
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/HUD-ANATOMY#symbol-table`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/HUD-ANATOMY#state-tuple`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/HUD-ANATOMY#confidence-syadasti`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/Signal_HUD_Tagspace-draft#header-field-taxonomy`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/Signal_HUD_Tagspace-draft#forward-vs-backward-trace`.
...
Migrated from `lar:///ha.ka.ba/@lares/docs/pono/hud/Signal_HUD_Tagspace-draft#in-flow-rendering-options` and `#rendering-across-p-scale`.
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/micro-trace >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/provenance >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/drift >>
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/hud >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/pono/hud >>
