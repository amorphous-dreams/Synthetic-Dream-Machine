...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/lararium/tw5-deserializer >>
```toml iam
uri-path     = "ha.ka.ba/@lares/docs/lararium/tw5-deserializer"
file-path = "packages/lares-core/memes/docs/lararium/tw5-deserializer.md"
...
source       = "lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/deserializer"
```
...
The canonical source is at `lar:///ha.ka.ba/@lares/api/v0.1/lararium/modules/deserializer`.
