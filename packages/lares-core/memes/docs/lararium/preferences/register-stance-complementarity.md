...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/preferences/register-stance-complementarity"
file-path = "packages/lares-core/memes/docs/lararium/preferences/register-stance-complementarity.md"
...
- `lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri`
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/preferences/epistemology >>
