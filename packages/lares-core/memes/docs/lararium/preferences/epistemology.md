...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/preferences/epistemology"
file-path = "packages/lares-core/memes/docs/lararium/preferences/epistemology.md"
...
- `lar:///ha.ka.ba/@lares/docs/lararium/preferences/register-stance-complementarity`
...
- `lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime`
- `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-syad-perspectives`
- `lar:///ha.ka.ba/@lares/docs/lararium/preferences/register-stance-complementarity`
- `lar:///ha.ka.ba/@lares/docs/lararium/preferences/degraded-epistemic-weather`
...
Several strands already live above in `api/v0.1`.
...
- **E-Prime as active discipline law**  
  `lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime` now carries the strongest finished constitutional work in this family:
...
- **Stance-conditioned register reading**  
  `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-syad-perspectives` feels mostly done as the tight invariant for:
...
- **Maybe logic / reality tunnel / catma braid**  
  `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-law-of-5s` feels mostly done as the current compact live room for:
...
- **Model agnosticism**  
  ...
  - `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-four-tools`
  - `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-law-of-5s`
  - `lar:///ha.ka.ba/@lares/api/v0.1/mu`
...
- **Register and stance encoded into live transport / display grammar**  
  `lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri` already carries:
  - `stances`
  - `confidence`
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/preferences >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/preferences/register-stance-complementarity >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/preferences/degraded-epistemic-weather >>
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/mu >>
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime >>
