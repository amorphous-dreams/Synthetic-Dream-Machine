...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/preferences/collaboration-model"
file-path = "packages/lares-core/memes/docs/lararium/preferences/collaboration-model.md"
...
- `lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices`
- `lar:///ha.ka.ba/@lares/api/v0.1/lararium/continuity`
- `lar:///LARES`
