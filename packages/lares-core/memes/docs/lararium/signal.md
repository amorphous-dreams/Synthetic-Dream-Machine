...
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/signal"
file-path = "packages/lares-core/memes/docs/lararium/signal.md"
...
|---|---|---|
| Canonical URI vector | audit-ready record form for exchange boundaries | parent branch framing, see `lar:///ha.ka.ba/@lares/docs/lararium/signal/tagspace` |
| HUD line | live exchange-boundary instrument rendered from the vector | `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud` |
| Micro-trace | compact in-span annotation under the governing header | `lar:///ha.ka.ba/@lares/docs/lararium/signal/micro-trace` |
| Render targets | cross-surface sigilization and projection rules | `lar:///ha.ka.ba/@lares/docs/lararium/signal/render-targets` |
| SA-display framing | shared-mental-model theory, research grounding, and SA/XAI split | `lar:///ha.ka.ba/@lares/docs/lararium/signal/sa-display` |
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/hud >>
...
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/sa-display >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/lararium/signal/tagspace >>
