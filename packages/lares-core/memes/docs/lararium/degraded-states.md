...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/lararium/degraded-states >>
```toml iam
uri-path = "ha.ka.ba/@lares/docs/lararium/degraded-states"
file-path = "packages/lares-core/memes/docs/lararium/degraded-states.md"
