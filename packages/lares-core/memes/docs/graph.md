...
file-path = "packages/lares-core/memes/docs/graph.md"
...
The canonical pranala law (`lar:///ha.ka.ba/@lares/api/v0.1/pono/pranala`) settles this:
...
The canonical loci law (`lar:///ha.ka.ba/@lares/api/v0.1/pono/loci`) uses **locus / loci** for a carrier in the graph.
