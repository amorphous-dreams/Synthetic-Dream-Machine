...
file-path = "packages/lares-core/memes/docs/pono/lar-uri.md"
...
Law lives in `lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri`.
...
**Slot semantics:** left slot = feed axis (`*`/`~`/`-`), right slot = zoom axis (`!`/`?`/`-`). Carrying two feed-axis tools (`*~`) produces a Visibility Conflict (Signal Jam). Carrying two zoom-axis tools (`?!`) produces a Resolution Conflict (Dubious Move). See `lar:///ha.ka.ba/@lares/api/v0.1/mu/the-four-tools` for the full tool-carry model.
...
**Origin address:** `lar:///ha.ka.ba/@lares/` is the (0,0,0) of tagspace — the root stable address from which all HA.KA.BA coordinates extend. Sub-path extensions navigate within the named territory: `lar:///ha.ka.ba/@lares/docs/pono/lar-uri/` locates this document. The HA.KA.BA triple remains stable; the sub-path narrows scope.
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri/SKILL >>
<<~ loulou lar:///ha.ka.ba/@lares/docs/pono/hud/HUD-ANATOMY >>

<<~ pranala #implements-meme ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/meme family:control role:implements >>
<<~ pranala #implements-loci ? -> lar:///ha.ka.ba/@lares/api/v0.1/pono/loci family:control role:implements >>
<<~ pranala #implements-lar-uri ? -> lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri family:control role:implements >>
<<~/ahu >>
