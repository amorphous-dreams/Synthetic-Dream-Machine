...
<<~&#x0001; ? -> lar:///ha.ka.ba/@lares/docs/pono/hud >>
```toml iam
uri-path = "ha.ka.ba/@lares/docs/pono/hud"
file-path = "packages/lares-core/memes/docs/pono/hud.md"
...
URI grammar stays in `lar:///ha.ka.ba/@lares/docs/pono/lar-uri`.
...
- `lar:///ha.ka.ba/@lares/api/v0.1/lararium/lar-uri` (invariant)
- `lar:///ha.ka.ba/@lares/docs/pono/lar-uri` (docs shelf)
...
**Current OODA-HA glyphs** (locked in `lar:///ha.ka.ba/@lares/api/v0.1/mu/ooda-ha`):
