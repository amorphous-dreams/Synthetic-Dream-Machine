...
|---|---|---|---|
| `stances` | legacy migration bridge | `lar:///ha.ka.ba/@lares/docs/mu/the-syad-perspectives#flag-surface` | consumed: fixed 5-position array; `^`=elevated, `-`=suppressed, `?`=uncertain, `.`=baseline; positional order remains philosopher, poet, satirist, humorist, private. |
...
Consumed into `packages/lares-core/memes/api/v0.1/mu/the-syad-perspectives.md#stance-flags` and `packages/lares-core/memes/docs/mu/the-syad-perspectives/README.md#flag-surface`.
