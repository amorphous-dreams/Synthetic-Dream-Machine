...
> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal#migrated-tagspace-intent-vs-in-flow`

---

## Header Field Taxonomy *(migrated)*

> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud#migrated-tagspace-header-field-taxonomy`

---

## Forward vs Backward Trace *(migrated)*

> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal#migrated-tagspace-forward-vs-backward-trace`

---

## HAKABA Alignment *(migrated)*

> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal#migrated-tagspace-hakaba-alignment`

---

## In-Flow Rendering Options *(migrated)*

> Migrated to `lar:///ha.ka.ba/@lares/docs/lararium/signal/hud#migrated-tagspace-in-flow-rendering-options`
...
[Canon: lar:///ha.ka.ba/@lares/docs/story/lindwyrm/kindling-of-the-crossroads-node#two-axes]
