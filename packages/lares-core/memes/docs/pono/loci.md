...
file-path = "packages/lares-core/memes/docs/pono/loci.md"
...
Extended notes, rating guidance, canon promotion criteria, and MCP roadmap for `lar:///ha.ka.ba/@lares/api/v0.1/pono/loci`.
...
Full five-register rubric at `lar:///ha.ka.ba/@lares/api/v0.1/pono/meme#rating-targets`. Loci governs routing, convention, and opener changes along the climb from noise to canon.
...
- all nine required elements (R1–R9) per `lar:///ha.ka.ba/@lares/api/v0.1/pono/meme`
...
- no outstanding declared-unresolved sub-meme addresses (O7 rule per `lar:///ha.ka.ba/@lares/api/v0.1/pono/meme#optional-elements`)
...
These layer atop the generic meme ratings at `lar:///ha.ka.ba/@lares/api/v0.1/pono/meme#rating-targets`. A local path hit raises evidence; it never overrides honest unresolved tension.

---

## High-Rating Loci Conditions

`lar:///ha.ka.ba/@lares/api/v0.1/pono/meme#rating-targets` governs the generic structural climb. Loci adds routing-and-convention predicates for memes whose carrier identity forms part of the law surface.
