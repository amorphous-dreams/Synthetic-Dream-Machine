...
file-path = "packages/lares-core/memes/docs/pono/exchange-vector.md"
...
The law lives at `lar:///ha.ka.ba/@lares/api/v0.1/lararium/exchange-vector`.
...
<<~ loulou lar:///ha.ka.ba/@lares/api/v0.1/lararium/exchange-vector >>
