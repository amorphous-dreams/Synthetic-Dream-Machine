...
file-path = "packages/lares-core/memes/docs/lares/voices/invariant-plan.md"
...
mana = 0.80
manao = 0.84
role = "OODA-HA plan for designing lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices invariant from the settled docs spec"
cacheable = false
retain = false
created = "2026-04-23"
```
...
OODA-HA plan for upgrading `lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices`
...
| File | Current state |
|---|---|
| `packages/lares-core/memes/api/v0.1/lararium/voices.md` | skeletal placeholder; declares `role`, `implements`, `hydrate`, `retain`; no substantive content |
...
The invariant's `#entry` pranala already wires to `lar:///ha.ka.ba/@lares/api/v0.1/lararium#hydrate-voices`.
...
- [ ] create `packages/lares-core/memes/api/v0.1/masks/` tree with a parent index meme (`masks.md` → `lar:///ha.ka.ba/@lares/api/v0.1/masks`)
- [ ] write `packages/lares-core/memes/api/v0.1/masks/ghost-of-mark-twain.md` from founding example in docs
- [ ] write `packages/lares-core/memes/api/v0.1/masks/friend-computer.md` from founding example in docs
- [ ] open `packages/lares-core/memes/api/v0.1/lararium/voices.md`
