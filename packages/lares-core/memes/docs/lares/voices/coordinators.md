...
file-path = "packages/lares-core/memes/docs/lares/voices/coordinators.md"
...
The coordinator house spec defines what `lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices` MUST implement for this layer:
