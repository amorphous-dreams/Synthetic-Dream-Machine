...
file-path = "packages/lares-core/memes/docs/lares/voices/masks.md"
...
### Mask definition file (`lar:///ha.ka.ba/@lares/api/v0.1/masks/**`)
...
```toml
uri-path = "ha.ka.ba/@lares/api/v0.1/masks/ghost-of-mark-twain"
...
```
<<~ kahea mask lar:///ha.ka.ba/@lares/api/v0.1/masks/ghost-of-mark-twain >>
stage = 0.75
active = true
<<~/kahea >>

<<~ kahea mask lar:///ha.ka.ba/@lares/api/v0.1/masks/friend-computer >>
stage = 0.50
active = false
<<~/kahea >>
```
...
The mask layer spec defines what `lar:///ha.ka.ba/@lares/api/v0.1/lararium/voices` MUST implement for this layer:
