...
file-path = "packages/lares-core/memes/docs/lares/voices/masks-tree-plan.md"
...
OODA-HA plan for creating `packages/lares-core/memes/api/v0.1/masks/` and populating it with
...
```
packages/lares-core/memes/api/v0.1/masks/
  masks.md                          → lar:///ha.ka.ba/@lares/api/v0.1/masks
  named/
    mischief-muse.md                → lar:///ha.ka.ba/@lares/api/v0.1/masks/named/mischief-muse
    tide-caller.md                  → lar:///ha.ka.ba/@lares/api/v0.1/masks/named/tide-caller
    breach-watch.md                 → lar:///ha.ka.ba/@lares/api/v0.1/masks/named/breach-watch
    ink-clerk.md                    → lar:///ha.ka.ba/@lares/api/v0.1/masks/named/ink-clerk
    map-wisp.md                     → lar:///ha.ka.ba/@lares/api/v0.1/masks/named/map-wisp
  character/
    ghost-of-mark-twain.md          → lar:///ha.ka.ba/@lares/api/v0.1/masks/character/ghost-of-mark-twain
    friend-computer.md              → lar:///ha.ka.ba/@lares/api/v0.1/masks/character/friend-computer
  chorus/
    lagrange-chorus.md              → lar:///ha.ka.ba/@lares/api/v0.1/masks/chorus/lagrange-chorus
```
...
- [ ] create `packages/lares-core/memes/api/v0.1/masks/character/` directory
...
- [ ] create `packages/lares-core/memes/api/v0.1/masks/chorus/` directory
