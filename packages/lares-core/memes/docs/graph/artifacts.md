...
file-path = "packages/lares-core/memes/docs/graph/artifacts.md"
...
```json
{
  ...
  "pranala_edges": [
    {
      ...
      "to_uri": "lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime",
      "to_socket": "",
      "family": "control",
      "lifecycle": "template",
      "role": null,
  ...
  "invariant_index": {
    "lar:///ha.ka.ba/@lares/api/v0.1/pono/invariant": ["lar:///AGENTS", "..."]
  },
  "validation": {
    "all_resolved": true,
    "all_exist": true,
...
```json
{
  ...
  "hash_sequence": [
    ...
    {"uri": "lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime", "sha256": "<carrier_hash>", "depth": 1}
  ],
  "validation": {
    "all_resolved": true,
    "all_exist": true,
