...
file-path = "packages/lares-core/memes/docs/graph/pranala-parser.md"
...
The pranala law (source: `lar:///ha.ka.ba/@lares/api/v0.1/pono/pranala`) names four surface forms
...
**Authority:** canonical pranala kānāwai (`lar:///ha.ka.ba/@lares/api/v0.1/pono/pranala`):
...
```
<<~ ahu #edges >>
  <<~ pranala #preload-e-prime ? -> lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime family:control role:owns >>
```
...
|---|---|---|
| Full `lar:///` URI | `lar:///ha.ka.ba/@lares/api/v0.1/mu/e-prime` | use as-is |
| Full URI with fragment | `lar:///ha.ka.ba/@lares/api/v0.1/mu#entry` | split into `to_uri` and `to_socket` |
| Relative path | `mu/chao` | prepend current carrier's root (`lar:///ha.ka.ba/@lares/api/v0.1/`) |
