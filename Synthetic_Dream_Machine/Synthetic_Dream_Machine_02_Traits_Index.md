...
## **Background** {#sdm-trait-background} (abstract)
...
> - usage:
>   - scope: powerlist; id: Vastlands Powers Chapter; note: See `Synthetic_Dream_Machine/Synthetic_Dream_Machine_02_Powers_Index.md` for canonical power listings that count as traits, and cross-reference those entries here as they come online.
<div class="trait-return">
  &nbsp;&nbsp;
