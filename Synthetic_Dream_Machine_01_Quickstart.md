...
- The caravan is a group character and a joint mobile base of operations; use the caravan sheet (or draw your own).
- **Money (Cash)**: track cash and weekly expenses in rough strokes; caravans start with a loan.
- **Financier (Patron)**: create the patron with the players; define goals, organization, opponents, weaknesses, oddities.
- **Logo**: every company gets one; changing it later costs 1d6 x €100 in fees.
- **Assets**: track investments in trade routes and related ventures; generate returns.
- **Time**: travel is near impossible in winter, harsh in summer; name each year.
- **Speed**: fast and slow tags cancel; speed adds or negates time tallies.
- **Traveling the Back Roads**: slow and cautious adds 7 days per week; bonuses to travel tests but roll twice.
- **Consumption**: weekly supplies consumed.
- **PCs**: list roles (expedition leader, navigator, guards, negotiator, mechanic/handler, doctor).
- **Helpers**: specialists with wages; default €6 per level per week.
...
**5: Tally Extra Days (UVG 2e, p. 168)**
...
**Look for Discoveries (UVG 2e, p. 170)**
...
**Buy and Sell (Haggling) (UVG 2e, p. 172)**
...
All is Transitory. All instances on your charactersheet are updateable.  
See the Vastlands Guidebook for:

* Shared Characters or Hallmarks  
* Recovering Invested Experience  
* Gaining New Traits Through Play (instead of Experience)  
