# TODO: Pre-AD&D Spell Material Staging - Men & Magic / Greyhawk / Holmes

## Men & Magic

```text id="mm-spell-list-witness"
{placeholder: Men & Magic spell-list witness block}
```

```text id="mm-clairaudience"
[Source metadata]
...
```text id="mm-magical-context"
{placeholder: Men & Magic adjacent magical-context rules block}
```

## Greyhawk

```text id="gh-spell-list-witness"
{placeholder: Greyhawk spell-list witness block}
```
...
```text id="gh-magical-context"
{placeholder: Greyhawk adjacent magical-context rules block}
```

## Holmes

```text id="hb-spell-list-witness"
{placeholder: Holmes spell-list witness block}
```
...
```text id="hb-ray-of-enfeeblement"
[Source metadata]
Title: Dungeons & Dragons Basic Set
Year: 1977
Source URL: https://www.americanroads.us/DandD/DnD_Basic_Rules_Holmes.pdf
