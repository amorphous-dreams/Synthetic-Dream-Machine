...
- 2026-03-25 lane-first rebucket pass: Phase 1 headings now use parent buckets in fixed order `B`, `E`, `C`, `M`, `I`, `RC` with topic sub-buckets (Arcane, Cleric, Druid, and RC spell/interface catch-up). Row content was preserved; only section structure and guidance text were updated.
- 2026-03-25 rebucket verification pass (continuation): confirmed all misbucketed rows successfully relocated (Expert arcane spells moved to E bucket ✓, Master procedures moved to M/I buckets ✓). RC bucket now contains true RC-primary spells only (Analyze, Entangle, Create Air, Clothform, Stoneform, Woodform, Ironform, Steelform, Delayed Blast Fireball). No Expert-only or Companion-only rows remain in RC bucket. Item/Interface Effects and Procedures subsections in RC are correctly empty with explicit documentation notes. Unique spell/effect count stable at 241 (variance of 1 from previous pass likely due to validation improvements).
...
5. Archive the staging corpus to `_todo/archive_phase1_freeze_2026-03-23/` when operator confirms the Phase 1 freeze is final.
6. Run a provenance uplift pass against `RC-only` and single-lane rows so spells that clearly have both pre-`RC` BECMI and `RC` evidence are normalized to dual-source form before Chapter 06 bulk export accelerates.
...
Expert catalog dedupe note: when an BECMI era spell is shared across cleric and magic-user lists, keep one canonical row with full cross-tradition class tags to avoid note drift. Source-era spelling or capitalization variants may be retained only as alias language inside that single row's notes.
...
| Classic Name | Class(es)/Spell-level | Source Book(s) | Staging Anchor / Section | Type | Notes | Mapping Status | Ch06 Import |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Bless | C2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical Spells List and Spell Descriptions | spell | Morale and combat blessing lane. | undecided | ✓ |
| Continual Light | C3, MU2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical and Magical Spells Lists and Spell Descriptions | spell | Clerical light / darkness lane as well as arcane one. | undecided | ✓ |
...
| Find Traps | C2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical Spells List and Spell Descriptions | spell | Detection and hazard-reading spell. | undecided | ✓ |
| Growth of Animal | C3 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical Spells List and Spell Descriptions | spell | Creature enhancement / scaling lane. | undecided | ✓ |
...
| Remove Curse | C3, MU4 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical and Magical Spells Lists and Spell Descriptions | spell | Major curse-removal recognizer. | undecided | ✓ |
...
| Silence 15' Radius | C2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical Spells List and Spell Descriptions | spell | Anti-speech and anti-spellcasting field lane; grouped ECM pass treats it as a partial noospheric-jamming / casting-denial cousin. | partial | ✓ |
| Snake Charm | C2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Clerical Spells List and Spell Descriptions | spell | Creature-specific charm/control spell. | undecided | ✓ |
...
| Mirror Image | MU2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Defensive illusion / misdirection lane. | undecided | ✓ |
| Phantasmal Force | MU2 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Core illusion-construction spell. | undecided | ✓ |
...
| Anti-Magic Shell | MU6 | Expert, Master, RC | Expert -> Clerical and Magic-User Spell Expansions; Master -> Artifact Power Doctrine and Artifact Effect Procedures; RC -> Magical Spells List and Spell Descriptions | spell | Major counter-magic boundary recognizer. Treat as a bespoke ECM shell with explicit ingress/egress and suppression behavior at boundary edges, not as a generic resistance buff. | custom | ✓ |
...
| Cloudkill | MU5 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | High-tier battlefield hazard / area denial lane. | undecided | ✓ |
...
| Death Spell | MU6 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | High-tier kill / sweep spell lane. | undecided | ✓ |
...
| Disintegrate | MU6 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Matter-destruction lane. | undecided | ✓ |
| Geas | MU6 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Compulsion / binding lane. | undecided | ✓ |
...
| Hallucinatory Terrain | MU4 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Large-scale illusion / terrain falsification lane. | undecided | ✓ |
...
| Ice Storm/Wall | MU4 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Hybrid artillery / wall-control lane. | undecided | ✓ |
...
| Stone to Flesh | MU6 | Expert, RC | Expert -> Clerical and Magic-User Spell Expansions; RC -> Magical Spells List and Spell Descriptions | spell | Petrification-reversal lane. | undecided | ✓ |
...
| Protection from Magic |  | Expert, RC | Expert -> Protection Scrolls; RC -> Scrolls | item-effect | Protection-scroll ECM ward that blocks spells and spell effects from crossing the boundary; useful as a Chapter 05 boundary-interface model for denial fields rather than generic resistance. | custom | — |
...
| Earthquake | C7 | Companion, Master, RC | Companion -> High-Level Cleric Spell Material; Master -> Seventh-Level Cleric Spells; RC -> Clerical Spells List and Spell Descriptions | spell | High-tier terrain and structural disruption lane. | undecided | ✓ |
...
| Hold Animal | Dr3 | Companion, Master, RC | Companion -> Druid Spell Material; Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Beast-specific restraint lane. | undecided | ✓ |
| Locate | Dr1 | Companion, Master, RC | Companion -> Druid Spell Material; Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Druidic animal / plant location lane. | undecided | ✓ |
| Metal to Wood | Dr7 | Companion, Master, RC | Companion -> Druid Spell Material; Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Material transformation lane. | undecided | ✓ |
...
| Produce Fire | Dr2 | Companion, Master, RC | Companion -> Druid Spell Material; Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Portable flame / attack lane. | undecided | ✓ |
| Protection from Lightning | Dr4 | Companion, Master, RC | Companion -> Druid Spell Material; Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Elemental defense lane. | undecided | ✓ |
...
| Dissolve | Dr5, MU5 | Master, RC | Master -> Druid Spell Material; RC -> Druidic and Magical Spells Lists and Spell Descriptions | spell | Terrain-liquefaction lane; compare mud / stone transmutation effects. | undecided | ✓ |
| Heat Metal | Dr2 | Master, RC | Master -> Druid Spell Material; RC -> Druidic Spells List and Spell Descriptions | spell | Sustained heat / anti-armor / concentration-break lane. | undecided | ✓ |
...
| Wizardry | C7 | Master, RC | Master -> Seventh-Level Cleric Spells; RC -> Clerical Spells List and Spell Descriptions | spell | Cross-tradition item / scroll use bridge lane. | undecided | ✓ |
...
| Dance | MU8 | Master, RC | Master -> Eighth-Level Magic-User Spells; RC -> Magical Spells List and Spell Descriptions | spell | Forced-movement / compulsion lane. | undecided | ✓ |
| Explosive Cloud | MU8 | Master, RC | Master -> Eighth-Level Magic-User Spells; RC -> Magical Spells List and Spell Descriptions | spell | High-tier area hazard lane. | undecided | ✓ |
...
| Power Word Blind | MU8 | Master, RC | Master -> Eighth-Level Magic-User Spells; RC -> Magical Spells List and Spell Descriptions | spell | Word-of-power debilitation lane. | undecided | ✓ |
| Power Word Kill | MU9 | Master, RC | Master -> Eighth-Level and Ninth-Level Magic-User Spells; RC -> Magical Spells List and Spell Descriptions | spell | Word-of-power execution lane. | undecided | ✓ |
...
| Statue | MU7 | Master, RC | Master -> Artifact Power Doctrine and Artifact Effect Procedures; RC -> Magical Spells List and Spell Descriptions | spell | Self-concealment and false-object transformation lane. | undecided | ✓ |
...
| Dance | spell | Forced-movement / compulsion lane. | undecided |
