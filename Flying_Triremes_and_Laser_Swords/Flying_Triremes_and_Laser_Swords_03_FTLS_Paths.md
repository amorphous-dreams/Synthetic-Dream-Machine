...
> *Who rolls*:  When using **Formations & Mass Combat** (@FLTS, Chapter 08), a Commander runs a Formation (themselves and attached Units/Vehicles). When an attached Unit acts, the Commander makes a single attack roll using that Unit’s attack type and may spend a Command Die (d6) to add to the roll. If no Commander is present, a random Unit member rolls to attack. The Unit rolls its own damage dice and the Commander may Focus all damage on one target, or Spread damage among eligible targets. The referee determines which attackers are actually engaged (in reach / line-of-effect) and therefore contribute damage.
>
...
1. **Teamwork.** Gain a +2 bonus and +2 Defense when standing next to an ally. Expert: When you gain the Teamwork bonus, one the nearby ally characters also gains +2 Defense. Master: While you are standing next to any Unit, all allies in that Unit gain +2 Defense.
