...
An immortal divine program / living principle in the Vastlands sense: fragmented, transactional, and commonly expressed through infrastructure, rites, relics, and agents rather than a single body. Choose a Name and Noospheric Domain (one short phrase: Roads, Ash, Contracts, Mercy, Rot, Signal, Storm, etc.). An organization may exist (cult, bureaucracy, guild, temple-net, pilgrimage route, saint-chain)… or only scraps remain, a small god running on inertia, rumor, and broken shrines. Daemon claim the metaphsics of Favorite Primary Characters, Experience custody, and Hero Dice. A godling may also be a Daemon, but it’s uncommon.
...
Gods do not “show up” so much as leak into the world through their interfaces. Mortals read godsign not for favor, but to avoid the danger of an oblivious immortal about its ineffable business; the old clear channels are gone, and signals are confused. In Elyncia’s broken geography, this sometimes becomes literal: you may find an embodied avatar-instance — reachable, parleyable, endurable — while the god remains vast and here-yet-elsewhere.
...
The other gods are like roaming programs, broken protocols, and half-functional astral-intelligences. Elyncia is the **operating substrate** they run on: her ley-lines as nerves, her noosphere as breath, her weather as mood, her ruins as old memories that still have teeth. Even asleep, she is ever-present; you can bargain with a storm-god, but you *live inside* Elyncia.
