...
- **Quiet Approach:** spend extra time or resources (referee's call) to reduce Area **Heat** for this action by 1 (min 1).
...
- **Tick Attention:** [verb] To add the Area **Heat** (with any mods, minimum +1) to the Area Attention score.
...
The profile for an **Area** (also known as a Discovery in SDM). Tracks how hard it pushes back (**Level**), how fast it reacts (**Heat**), the noospheric weirdness level (**Arcane**), the common technology level (**Tech**), how active it is now (**Attention**), and what it’s like (**Tags**). Note any discovered **Nodes** here—plus whatever else you need at the table.

**Area:** Name (Level, Heat)
- **Arcane:**
- **Tech:**
- **Attention:**
- **Tags:**
...
| --- | --- | --- | --- |
| **0** | Dead-calm noösphere (extremely rare). Signal is clean, rites behave, and “magic weather” is effectively absent. If anything strange happens, it’s a plot event or a relic being triggered, not background conditions. | Clean comms, clear divinations | One-off anomalies |
| **1–2** | Low background noise. Oddities cluster at **known sites**, taboos, seasons, and specific rituals. Most work is mundane; the weird has fences (even if the fences are social). | Standard wards, safe noosphere channels | Site-haunts, minor bleed |
| **3–4** | Noticeable drift. Low-grade haunt/glitch is part of daily risk management: crews schedule around it, carry filters, keep ritual discipline, and treat “noöspheric hygiene” like boots and bandages. | Filters, grounding, ward checks | Signal scramble, echoes, minor possession |
| **5–6** | Frequent interference. “Normal ops” regularly brush hazard triggers: readings lie, tools misfire, coincidences tighten, and repeated work leaves a signature. Quiet approach matters; skilled operators start to feel mandatory. | Hardened protocols, safe rooms | Surges, ghost-code, spontaneous wild-magic |
...
Like morale and reaction rolls, a random character rolls for the group (unless a trait or ritual is in play). The vibes spread fast. The noösphere is a social medium. Use the same instincts as reaction rolls, and take 1 point of Charisma damage to re-roll. Botches are possible, if penalties apply.
...
| Tech | Description | Reliable | Weird |
| --- | --- | --- | --- |
| **0** | Nearly no tools beyond hand/stone/bone/cord. Knowledge is embodied, local, and fragile; “tech” is mostly muscle, fire, shelter, and luck. | Fire, shelters, traps | Anomalies-as-weather |
| **1–2** | Craft cultures with scarce literacy/standardization. Tools are made, repaired, inherited; “named steel” is legendary. Small communities run on tradition, taboos, and practical know-how. | Craft tools, boats, herbs | Charms, shrine-wards |
| **3–4** | Reliable engineered systems at town/city scale: standard gear, mapped routes, workshops, civic works, repeatable medicine, and institutions that store knowledge (guilds, temples, offices). | Roads, mills, clinics | Licensed rites, labs |
| **5–6** | Mature industry plus ubiquitous weird gear. Logistics, mass production, and regulation exist alongside thriving gray markets. Powers and devices are products: priced, traded, restricted, counterfeited. | Factories, guns, networks | Consumer magitech |
| **7–8** | High oldtech/fantascience density with autonomous systems. Identity, surveillance, servitors, and infrastructure behave like software. Reality-adjacent tools (memory/space/force) are routine for institutions and elites. | Autonomy, portals (local) | Mind/space tools |
| **9+** | Builder-grade artifacts shape whole societies/sites. Some systems feel like cheating: replication, body/personality transfer, pocket dimensions, strategic deterrents. Understanding is optional; access is everything. | “Cheat” infrastructure | World-scale levers |
| **10–17** | Mythic systems: megastructures, planetary nodes, timeweave infrastructure, god-machine supply chains. Not “devices,” but operating layers of the world—things you negotiate with, steal keys from, or survive. | Permissions, keys | Reality syscalls |
...
**Reliability:**
Everything is hands-on and immediate. If you can’t carry it, tie it, burn it, or eat it, it doesn’t exist. Tools work when you work.

**Scarcity:**
Extreme scarcity of durable materials, spares, and specialists. Time and calories are the main currencies. Complex goods are essentially nonexistent.

**Magitech / Fantascience / Powers:**
Mostly absent. “Weird” shows up as **environmental wrongness** (haunted springs, mutating dust, cursed meteor glass) rather than controllable tools. Powers—if they appear—are one-off miracles or catastrophes, usually tied to taboo, blood, or place.
...
**Reliability:**
Craft is reliable within its tradition: woven things, fired things, hammered things. Repairs happen constantly. People know what breaks and how.

**Scarcity:**
Named materials and specialist knowledge are scarce and socially gated. Literacy is limited; accurate maps are rare; high-quality metal is a prestige object.

**Magitech / Fantascience / Powers:**
Magitech exists as **charms and wards** that work because everyone agrees they work (and because the shrine is maintained). Fantascience appears as misunderstood relic behavior (“the singing pipe,” “the blue glass that remembers”). Powers are slow, ritualized, and costly—stable only inside a community’s rites.
...
**Reliability:**
Systems become repeatable: workshops, guild standards, town infrastructure, known routes, schedules, and basic professional medicine. Institutions begin to outlive individuals.

**Scarcity:**
Scarcity is managed rather than absolute. Some goods are still rare (fine steel, drugs, special components), but markets and bureaucracy can move them—at a price.

**Magitech / Fantascience / Powers:**
Magitech becomes a **public service layer** (gate wards, oath seals, signal lamps, blessed wells). Fantascience exists as labs, heresitech dens, and “research problems” that can be reproduced by experts. Powers are known as a category—stored in books/objects—and increasingly regulated (temple licenses, ministry lists, guild monopolies).
...
**Reliability:**
Industrial reliability: mass goods, standardized parts, logistics, dependable weapons, and routine repair culture. Enforcement and regulation are real—if uneven.

**Scarcity:**
Scarcity is engineered: rationing, pricing, controlled substances, permits, “shortages,” and black markets. The poor lack access, not possibility.

**Magitech / Fantascience / Powers:**
Magitech turns into **consumer devices** (ward coats, glow-signage, comm beads, stim-heals, self-heating kits). Fantascience becomes semi-routine “illegal tech” (mutation salons, mind hacks, energy emitters) with street protocols. Powers are commodified and policed—sold like drugs, carried like weapons, insured like property.
...
**Reliability:**
Autonomous systems are normal: servitors, surveillance, identity systems, and infrastructure that behaves like software. Complex maintenance exists (though it may be exploitative or fragile under stress).

**Scarcity:**
Scarcity is political: access tiers, privilege tokens, subscription realities, bureaucratic existence. Your biggest risk is losing recognition—becoming “unpersoned.”

**Magitech / Fantascience / Powers:**
Magitech becomes city-scale and institutional (force barriers, environmental seals, daemon services, wide comms, sanctioned summons). Fantascience becomes routine reality-adjacent tooling: memory edits, personality overlays, localized space/force tricks. Powers are professionalized: schools, safety protocols, incident response, and the occasional spectacular containment failure.
...
**Reliability:**
If you have access, it works *too well*. The reliability comes from systems that are effectively “above” local reality: replication, transfer, containment, deep transit. Understanding is optional; authorization is mandatory.

**Scarcity:**
Scarcity shifts from resources to **keys**: credentials, bloodlines, oaths, ancient tokens, angelic recognition, location-anchors. The economy is access-control.

**Magitech / Fantascience / Powers:**
Magitech looks like theology and customer service at the same time: kiosks that answer prayers, angels that audit your travel ticket, rituals that are actually interface protocols. Fantascience is stable enough to become law and medicine. Powers stop being “spells” and become **civilization functions**: identity, enforcement, travel, scarcity, and memory are power-mediated.

---

#### Tech 10–17 (Mythic Systems)

**Reliability:**
These aren’t tools you “use.” They are **world processes** you survive, redirect, bind, bargain with, or steal access from. Reliability exists as cosmic procedure: permissions, keys, timing, and alignment.

**Scarcity:**
Scarcity becomes metaphysical: right names, right keys, right phase of the cycle, right place in the lattice. Material goods matter less than *position* in the system.

**Magitech / Fantascience / Powers:**
Magitech becomes indistinguishable from divine bureaucracy: oath-logic, keys, seals, angels, ministries, jubilees. Fantascience becomes ontology editing—changing what a person is, what a year means, what death does. Powers are infrastructural syscalls: you’re not throwing a fireball, you’re asking reality for an exception and hoping the audit doesn’t notice. Interaction is rarely “initiative”; it’s procedures, bargains, sabotage of inputs, and escaping the blast radius when the system corrects itself.

*The Lares Lagrange Nodes are “Tech 10+” exemplars: they’re routing/stability infrastructure-daemons, not “gear.”*

## Recon (Reconnaissance)

Recon starts before the first pry bar hits the wreckage: this section shows how crews leverage Discoveries as playable Areas, break each Area into workable Nodes, and then ride the Attention clock as pressure shifts from rumor to patrol to full response. Use the procedures below to find what a destination actually offers, decide what to touch, and track how the place answers through encounter checks, escalation bands, and random-complication flow.
...
Each Area has a **Level**, and **Heat**, **Arcane**, **Tech**, and **Attention** scores. Each area carries **Tags** (2–3 is plenty). A 1-day survey of an Area is worth XP and offers chances to scout for resource Nodes. An Area can have **0–3 Nodes** (things you can exploit); if the Area is explicitly “something to work,” it probably has at least 1. Each Node has a **name/description**, a **type** tag, and **one additional tag** beyond the Area’s tags.

> **Referee note: scale shifts**
> 
> Discovery happens on **week** scale (caravan/destination procedure). The moment the crew starts “working” an Area, shift to RSS’s **watch** scale (operations like Salvage) and **turn** scale (on-site exploration and danger timing).
...
- reduce the Area **Heat** by 1 (minimum 1).
...
**Foreman (Expert):** If an Expert or Master leads the crew (relevant trait), then the Foreman rolls. Competent work is quieter. Reduce the Area Heat rate by 1 for events from this job only (minimum 1). No Foreman? A random character rolls for the crew.
...
| 1s | **Botch.** Something went very wrong. Remove any matches, then roll a Hazard Die for each 1 remaining. If any hazards occur during a refinment, **Tick Attention** a second time. |
...
2. **Market Research Procedure (local demand/supply):**  
   ...
   For each destination, make a market roll:
    ...
    | 20 | 1 | Source! Buyers make haggling checks at an advantage, sellers at a disadvantage. |
...
| Bone-Sifter Staff | 2 st [static], 1 stone [static] [bone], 1 st [dynamic] | 2 stones, d8 damage. Reroll a Salvage Collection roll 1/day. |
...
| Item | Base Profile | Final Cost (Inv + Base Cash Value) | Constraint / Output | Core Tags |
| --- | --- | --- | --- | --- |
...
| [Water Purification Pills (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 sp`, `€5` | Inv: `2 sp`; Value: `>= €2.5` | Constraint: accurate tablet dosing and clean treatment chemistry. Output: 10-dose purification pack that makes roughly a week of water potable. | `[water] [purification] [sanitation]` |
| [UV Lotion (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 sp`, `€5` | Inv: `2 sp`; Value: `>= €2.5` | Constraint: stable, skin-safe UV-blocking formula. Output: topical anti-UV prep suitable for radiant exposure and long daytime travel. | `[sun] [radiant] [skin] [protection]` |
| [Nasal Filters (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 sp`, `€5` | Inv: `2 sp`; Value: `>= €2.5` | Constraint: proper fit and breathable filtration mesh. Output: personal filter set that suppresses foul-air nausea and reduces some inhaled toxin intake. | `[air] [filter] [respiratory] [toxin]` |
| [Smart Rope (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 st`, `€10` | Inv: `2 st`; Value: `>= €5` | Constraint: 20m command-knot line with reliable tensile grade. Output: self-tying utility rope for rapid anchoring, binding, and extraction work. | `[rope] [binding] [climbing] [utility]` |
...
| [Enviro Mask (VLG)](../Vastlands_Guidebook/Vastlands_Guidebook.md#page_0083) | `1 st`, `€50` | Inv: `2 st`; Value: `>= €25` | Constraint: airtight seal and spore/gas-rated filter stack. Output: expedition respirator for contaminated atmospheres and spell-tainted air pockets. | `[air] [filter] [hazmat] [toxin]` |
| [Oculars (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 st`, `€50` | Inv: `2 st`; Value: `>= €25` | Constraint: aligned zoom optics with stable rangefinder power. Output: recon optic suite with zoom, laser ranging, and signal clutter suppression. | `[optics] [recon] [rangefinding] [survey]` |
...
| [Curative Snake Oil (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 sp`, `€10` | Inv: `2 sp`; Value: `>= €5` | Constraint: stable broad-spectrum anti-venom/anti-parasite blend. Output: broad-spectrum field remedy for bites, bugs, rashes, blisters, and common ailments. | `[medicine] [remedy] [antitoxin] [fieldcare]` |
| [VC Healing Lotion (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0189) | `1 sp`, `€40` | Inv: `2 sp`; Value: `>= €20` | Constraint: sterile carrier with preserved regenerative actives. Output: high-potency restorative salve calibrated for major life recovery and physical stabilization. | `[healing] [recovery] [biological] [consumable]` |
| [Shield (there is only one) (UVG)](../Ultraviolet_Grasslands_and_the_Black_City_2e/Ultraviolet_Grasslands_and_the_Black_City_2e.md#page_0191) | `1 st`, `€5` | Inv: `2 st`; Value: `>= €2.5` | Constraint: reinforced +2 shield frame with sunder-safe break points. Output: standard +2 defensive shield that can be sacrificed to negate a hit. | `[shield] [defense] [cover] [armor]` |
| [Shield Mk74c (VLG)](../Vastlands_Guidebook/Vastlands_Guidebook.md#page_0075) | `1 st`, `€2` | Inv: `2 st`; Value: `>= €1` | Constraint: wicker/pleather integrity for routine impacts and sunder use. Output: cheap modern +2 shield with dependable sacrificial break behavior. | `[shield] [sunder] [defense] [wicker]` |
| [Strapguard (VLG)](../Vastlands_Guidebook/Vastlands_Guidebook.md#page_0075) | `1 st`, `€5` | Inv: `2 st`; Value: `>= €2.5` | Constraint: balanced forearm mount that keeps hands free. Output: +1 strapped guard that preserves hand availability for tools or weapons. | `[shield] [hands-free] [defense] [bracing]` |
| [Field Glove (VLG)](../Vastlands_Guidebook/Vastlands_Guidebook.md#page_0075) | `5 sp`, `€15` | Inv: `10 sp`; Value: `>= €7.5` | Constraint: controlled life-fed surge in living-wire gauntlet. Output: +1 gauntlet shield with emergency +1d6 defensive burst profile. | `[gauntlet] [field] [defense] [reactive]` |
...
| [Hazviral Suit (VLG)](../Vastlands_Guidebook/Vastlands_Guidebook.md#page_0075) | `1 st`, `€150` | Inv: `2 st`; Value: `>= €75` | Constraint: intact synthskin seals and enviro interfaces. Output: light enviro armor suited for toxins, dehydration pressure, and contaminated zones. | `[hazmat] [enviro] [sealed] [armor]` |
...
| Item | Base Profile | Final Cost (Inv + Base Cash Value) | Risk / Constraint / Output | Core Tags |
| --- | --- | --- | --- | --- |
...
- **Heat:** +3 (minimum 3)
- **Arcane:** +d6* (cap at 10; treat as maelstrom-tier)
- **Attention:** +d6*
