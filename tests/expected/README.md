...
|------|-----------------|--------|-------|
| `C-06--parse-boundary-vs-trace.md` | C-series (CLI Conventions) — parse boundary vs OODA-A trace split | **green** | Pins dense parse segmentation plus sparse event-level reply trace without conflating the two layers |
